...
const toggleMute=document.getElementById('mute_unmute');
let connected = false;
let room;
let chat;
let conv;
...
function mute() {
    ...
    if (!room || !room.localParticipant)
        ...
        console.log("ext")
        const track = new Twilio.Video.LocalAudioTrack(track);
        room.localParticipant.audioTracks.forEach(track => {
            track.disable();
        });
        console.log("ext")
    }
        // const muteAudio = document.getElementById('mute_unmute');
...
function unmute() {
    if (!room || !room.localParticipant)
        ...
        const unmuteAudio = document.getElementById('mute_unmute');
...
function onMuteUnmuteClick(trackType) {
    if (trackType === 'Audio') {
        ...
        isAudioMuted
            ? toggleMute.textContent = 'Unmute Audio'
            : toggleMute.textContent = 'Mute Audio';
    }
...
// toggleMute.addEventListener('click',onMuteUnmuteClick);
toggleMute.addEventListener('click', mute);
// const muteAudio = document.getElementById('mute_unmute');
